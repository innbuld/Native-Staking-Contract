...
contract Coke is Ownable, Stakeable{
    /**
  *   Tokens required variables that are needed to operate everything
  */
  ...
  /**
  *  _balances is a mapping that contains a address as KEY 
  ...
  * An allowance is the right to use another accounts balance, or part of it
  ...
  // event that notifies the blockchain that a transfer of assets has taken place
  ...
  */
  ...
  /**
  *  balanceOf will return the account balance for the given account
  */
  ...
  */
  function _mint(address account, uint256 amount) internal {
    require(account != address(0), "Cant mint to null address");
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Cant  burn from null address");
    require(_balances[account] >= amount, "Cannot burn more than the account balance");
  ...
  *
  ...
  /**
  *  transfer is used to transfer funds from the sender to the recipient
  ...
  *  - sender balance most be = or bigger than amount
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0), "Cant transfer from null address");
    require(recipient != address(0), "Cant transfer to null address");
   ...
   *   - owner and spender cannot be zero address
    */
    function _approve(address owner, address spender, uint256 amount) internal {
      require(owner != address(0), "Approve cannot be done from null address");
      require(spender != address(0), "Approve cannot be to null address");
    ...
    *   - The caller must have a allowance = or bigger than the amount spending
    ...
    function transferFrom(address spender, address recipient, uint256 amount) external returns(bool){
      ...
      require(_allowances[spender][msg.sender] >= amount, " You cannot spend more than allowed");
      // Transfer first
